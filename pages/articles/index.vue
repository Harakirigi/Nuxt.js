...
watch(() => route.query.tags, (tags) => {
    if (tags) {
        articles.value = articlesStore.articles.filter((article) => {
            return route.query.tags.toLocaleLowerCase() === article.tags?.toLocaleLowerCase();
        });
    } else {
...
// console.log(articles.forEach((article) => console.log(article.tags)));
// const editors = ref({});
